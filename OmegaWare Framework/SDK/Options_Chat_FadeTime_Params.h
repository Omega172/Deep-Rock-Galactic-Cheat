...
namespace CG
{
	 ...
	 */
	struct UOptions_Chat_FadeTime_C_Construct_Params
	{	};
	 ...
	 */
	struct UOptions_Chat_FadeTime_C_BndEvt__Basic_Slider_K2Node_ComponentBoundEvent_9_OnValueChanged__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct UOptions_Chat_FadeTime_C_ExecuteUbergraph_Options_Chat_FadeTime_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_DUEI[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function Options_Chat_FadeTime.Options_Chat_FadeTime_C.OnVolumeChanged__DelegateSignature
	 */
	struct UOptions_Chat_FadeTime_C_OnVolumeChanged__DelegateSignature_Params
	{
	public:
