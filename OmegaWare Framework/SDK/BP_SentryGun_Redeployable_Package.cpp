...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BP_SentryGun_Redeployable.BP_SentryGun_Redeployable_C.SetArcIndicatorActive
	 * 		Flags  -> ()
	 * Parameters:
	...
	void ABP_SentryGun_Redeployable_C::SetArcIndicatorActive(bool Active)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_SentryGun_Redeployable.BP_SentryGun_Redeployable_C.SetArcIndicatorActive");
		
		ABP_SentryGun_Redeployable_C_SetArcIndicatorActive_Params params {};
