...
namespace CG
{
	 ...
	 */
	struct UWeaponDisplay_Drill_Heat_C_Init_Params
	{
	public:
	 ...
	 */
	struct UWeaponDisplay_Drill_Heat_C_OnUnEquipped_Params
	{	};

	/**
	 * Function WeaponDisplay_Drill_Heat.WeaponDisplay_Drill_Heat_C.OnEquipped
	 */
	struct UWeaponDisplay_Drill_Heat_C_OnEquipped_Params
	{	};
