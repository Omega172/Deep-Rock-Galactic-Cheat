...
namespace CG
{
	...
	public:
		...
		class UFirstPersonWidgetComponent*                         MonitorWidget;                                           // 0x0440(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
