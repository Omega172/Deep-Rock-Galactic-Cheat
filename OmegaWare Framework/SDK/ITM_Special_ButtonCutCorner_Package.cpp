...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function ITM_Special_ButtonCutCorner.ITM_Special_ButtonCutCorner_C.SetFlipHorizontally
	 * 		Flags  -> ()
	 * Parameters:
	...
	void UITM_Special_ButtonCutCorner_C::SetFlipHorizontally(bool FlipButton)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ITM_Special_ButtonCutCorner.ITM_Special_ButtonCutCorner_C.SetFlipHorizontally");
		
		UITM_Special_ButtonCutCorner_C_SetFlipHorizontally_Params params {};
		params.FlipButton = FlipButton;
