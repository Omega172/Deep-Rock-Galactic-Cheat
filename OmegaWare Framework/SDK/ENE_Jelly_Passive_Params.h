...
namespace CG
{
	 ...
	 */
	struct AENE_Jelly_Passive_C_BndEvt__SimpleHealth_K2Node_ComponentBoundEvent_0_DeathSig__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct AENE_Jelly_Passive_C_OnDeath_Params
	{	};

	/**
	 * Function ENE_Jelly_Passive.ENE_Jelly_Passive_C.ExecuteUbergraph_ENE_Jelly_Passive
	 */
	struct AENE_Jelly_Passive_C_ExecuteUbergraph_ENE_Jelly_Passive_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_ZI5T[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
