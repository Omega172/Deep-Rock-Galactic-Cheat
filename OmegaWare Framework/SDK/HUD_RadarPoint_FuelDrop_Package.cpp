...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function HUD_RadarPoint_FuelDrop.HUD_RadarPoint_FuelDrop_C.InitPoint
	 * 		Flags  -> ()
	 * Parameters:
	...
	void UHUD_RadarPoint_FuelDrop_C::InitPoint(class URadarPointComponent* RadarComponent, bool* success)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HUD_RadarPoint_FuelDrop.HUD_RadarPoint_FuelDrop_C.InitPoint");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function HUD_RadarPoint_FuelDrop.HUD_RadarPoint_FuelDrop_C.Get3dPosition
	 * 		Flags  -> ()
	 * Parameters:
	...
	void UHUD_RadarPoint_FuelDrop_C::Get3dPosition(struct FVector* Pos)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HUD_RadarPoint_FuelDrop.HUD_RadarPoint_FuelDrop_C.Get3dPosition");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function HUD_RadarPoint_FuelDrop.HUD_RadarPoint_FuelDrop_C.UpdatePoint
	 * 		Flags  -> ()
	 * Parameters:
	...
	void UHUD_RadarPoint_FuelDrop_C::UpdatePoint(float alpha, float verticalDist, bool* destroy)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HUD_RadarPoint_FuelDrop.HUD_RadarPoint_FuelDrop_C.UpdatePoint");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UHUD_RadarPoint_FuelDrop_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UHUD_RadarPoint_FuelDrop_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass HUD_RadarPoint_FuelDrop.HUD_RadarPoint_FuelDrop_C");
		return ptr;
	}
