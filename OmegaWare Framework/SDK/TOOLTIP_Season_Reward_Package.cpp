...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function TOOLTIP_Season_Reward.TOOLTIP_Season_Reward_C.SetDataFromSkin
	 * 		Flags  -> ()
	 * Parameters:
	...
	void UTOOLTIP_Season_Reward_C::SetDataFromSkin(class UItemSkin* InSkin, class UItemID* InOptionalItem, class UPlayerCharacterID* InOptionalCharacter)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TOOLTIP_Season_Reward.TOOLTIP_Season_Reward_C.SetDataFromSkin");
		
		UTOOLTIP_Season_Reward_C_SetDataFromSkin_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function TOOLTIP_Season_Reward.TOOLTIP_Season_Reward_C.SetBottomText
	 * 		Flags  -> ()
	 * Parameters:
	...
	void UTOOLTIP_Season_Reward_C::SetBottomText(const class FText& InBottomText)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TOOLTIP_Season_Reward.TOOLTIP_Season_Reward_C.SetBottomText");
		
		UTOOLTIP_Season_Reward_C_SetBottomText_Params params {};
		params.InBottomText = InBottomText;
