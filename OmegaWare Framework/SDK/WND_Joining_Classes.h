...
namespace CG
{
	...
	public:
		...
		class UCircularThrobber*                                   CircularThrobber_3;                                      // 0x02C8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
