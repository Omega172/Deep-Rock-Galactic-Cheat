...
namespace CG
{
	 ...
	 */
	struct UABP_PlasmaCarbine_C_AnimGraph_Params
	{
	public:
	 ...
	 */
	struct UABP_PlasmaCarbine_C_BlueprintUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UABP_PlasmaCarbine_C_ExecuteUbergraph_ABP_PlasmaCarbine_Params
	{
	public:
