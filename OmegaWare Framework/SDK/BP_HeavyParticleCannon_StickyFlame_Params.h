...
namespace CG
{
	 ...
	 */
	struct ABP_HeavyParticleCannon_StickyFlame_C_ReceiveBeginPlay_Params
	{	};
	 ...
	 */
	struct ABP_HeavyParticleCannon_StickyFlame_C_ExecuteUbergraph_BP_HeavyParticleCannon_StickyFlame_Params
	{
	public:
