...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BBPV[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct ABP_SentryGun_Redeployable_C_SetArcIndicatorActive_Params
	{
	public:
