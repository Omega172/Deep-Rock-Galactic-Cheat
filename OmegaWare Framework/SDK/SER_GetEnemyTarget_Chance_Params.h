...
namespace CG
{
	 ...
	 */
	struct USER_GetEnemyTarget_Chance_C_GetEnemyTargetChance_Params
	{
	public:
	 ...
	 */
	struct USER_GetEnemyTarget_Chance_C_ReceiveTickAI_Params
	{
	public:
	 ...
	 */
	struct USER_GetEnemyTarget_Chance_C_ExecuteUbergraph_SER_GetEnemyTarget_Chance_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_AUOQ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
