...
namespace CG
{
	 ...
	 */
	struct UOptions_Gamepad_KeyBinding_C_PreConstruct_Params
	{
	public:
	 ...
	 */
	struct UOptions_Gamepad_KeyBinding_C_BndEvt__UI_KeyCapture_Primary_K2Node_ComponentBoundEvent_0_OnCapturingChanged__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct UOptions_Gamepad_KeyBinding_C_ExecuteUbergraph_Options_Gamepad_KeyBinding_Params
	{
	public:
