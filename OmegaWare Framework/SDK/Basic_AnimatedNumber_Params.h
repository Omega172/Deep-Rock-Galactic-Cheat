...
namespace CG
{
	 ...
	 */
	struct UBasic_AnimatedNumber_C_CountUp_Params
	{	};

	/**
	 * Function Basic_AnimatedNumber.Basic_AnimatedNumber_C.PreConstruct
	 */
	struct UBasic_AnimatedNumber_C_PreConstruct_Params
	{
	public:
	 ...
	 */
	struct UBasic_AnimatedNumber_C_SetNumber_Params
	{
	public:
	 ...
	 */
	struct UBasic_AnimatedNumber_C_ExecuteUbergraph_Basic_AnimatedNumber_Params
	{
	public:
