...
namespace CG
{
	...
	public:
		...
		class FString                                              NewVar_1;                                                // 0x0270(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash
		unsigned char                                              Events[0x10];                                            // 0x0280(0x0010) UNKNOWN PROPERTY: ArrayProperty
