...
namespace CG
{
	 ...
	 */
	struct ABP_DetPack_Charge_C_ShowWarningSphere_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_NX3F[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
