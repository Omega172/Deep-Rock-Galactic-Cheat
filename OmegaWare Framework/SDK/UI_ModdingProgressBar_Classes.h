...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_KFE5[0x3];                                   // 0x0285(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_V0B3[0x1];                                   // 0x0297(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
