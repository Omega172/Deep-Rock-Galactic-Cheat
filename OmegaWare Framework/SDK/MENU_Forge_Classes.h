...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_5365[0x4];                                   // 0x035C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MTKG[0x1];                                   // 0x036B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
