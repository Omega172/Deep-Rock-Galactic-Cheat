...
public:
	...
	uint8                                         Pad_29DD[0x10];                                    // 0x0038(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_29DE[0x138];                                   // 0x0028(0x0138)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, struct FGameplayTagSource>  TagSources;                                        // 0x0160(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_29DF[0x80];                                    // 0x01B0(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_29E0[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
