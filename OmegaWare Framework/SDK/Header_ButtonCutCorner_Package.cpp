...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function Header_ButtonCutCorner.Header_ButtonCutCorner_C.ToggleNotificationIcon
	 * 		Flags  -> ()
	 * Parameters:
	...
	void UHeader_ButtonCutCorner_C::ToggleNotificationIcon(bool InShow)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Header_ButtonCutCorner.Header_ButtonCutCorner_C.ToggleNotificationIcon");
		
		UHeader_ButtonCutCorner_C_ToggleNotificationIcon_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function Header_ButtonCutCorner.Header_ButtonCutCorner_C.Construct
	 * 		Flags  -> ()
	 */
	void UHeader_ButtonCutCorner_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Header_ButtonCutCorner.Header_ButtonCutCorner_C.Construct");
		
		UHeader_ButtonCutCorner_C_Construct_Params params {};
