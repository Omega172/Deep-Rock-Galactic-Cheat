...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_P7IN[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct APRJ_NormalBlasterShot_C_CustomEvent_Params
	{
	public:
	 ...
	 */
	struct APRJ_NormalBlasterShot_C_BndEvt__CollisionComponent_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature_Params
	{
	public:
		...
		unsigned char                                              UnknownData_BPCX[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
