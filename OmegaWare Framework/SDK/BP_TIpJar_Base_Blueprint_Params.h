...
namespace CG
{
	 ...
	 */
	struct ABP_TipJar_Base_Blueprint_C_All_PlayTip_Params
	{
	public:
	 ...
	 */
	struct ABP_TipJar_Base_Blueprint_C_BndEvt__BP_TipJarUsable_K2Node_ComponentBoundEvent_2_UsedBySignature__DelegateSignature_Params
	{
	public:
		class APlayerCharacter*                                    User;                                                    // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 ...
	 */
	struct ABP_TipJar_Base_Blueprint_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BP_TIpJar_Base_Blueprint.BP_TipJar_Base_Blueprint_C.ExecuteUbergraph_BP_TipJar_Base_Blueprint
	 */
	struct ABP_TipJar_Base_Blueprint_C_ExecuteUbergraph_BP_TipJar_Base_Blueprint_Params
	{
	public:
