...
namespace CG
{
	 ...
	 */
	struct UITM_SonyTeamLeader_C_SetSize_Params
	{
	public:
	 ...
	 */
	struct UITM_SonyTeamLeader_C_PreConstruct_Params
	{
	public:
	 ...
	 */
	struct UITM_SonyTeamLeader_C_ExecuteUbergraph_ITM_SonyTeamLeader_Params
	{
	public:
