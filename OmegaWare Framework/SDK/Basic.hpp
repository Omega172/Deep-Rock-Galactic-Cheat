...
namespace Offsets
{
	constexpr int32 GObjects          = 0x062F5C10;
	constexpr int32 AppendString      = 0x01AE95A0;
	constexpr int32 GNames            = 0x062B9640;
	constexpr int32 GWorld            = 0x0643C230;
	constexpr int32 ProcessEvent      = 0x01CFC9D0;
