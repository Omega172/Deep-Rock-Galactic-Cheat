...
namespace CG
{
	...
	public:
		...
		float                                                      Rotspeed;                                                // 0x02B0(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_L14T[0x4];                                   // 0x02B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SwitchMesh();
		void ExecuteUbergraph_BP_MinersManualConsole(int32_t EntryPoint);
