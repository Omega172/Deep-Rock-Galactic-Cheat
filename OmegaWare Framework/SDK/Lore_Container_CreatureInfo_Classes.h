...
namespace CG
{
	...
	public:
		...
		class UBasic_BG_CutCorner_C*                               Basic_BG_CutCorner_C_1;                                  // 0x0270(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		class UBasic_BG_CutCorner_C*                               Basic_BG_Window_C_1;                                     // 0x0278(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class UTextBlock*                                          TextBlock_5;                                             // 0x0310(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		void FillInAttacks(class UWrapBox* Container, TArray<struct FEnemyAttackDescription> Attacks);
