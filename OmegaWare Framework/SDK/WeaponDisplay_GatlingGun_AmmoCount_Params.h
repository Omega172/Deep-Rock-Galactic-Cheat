...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function WeaponDisplay_GatlingGun_AmmoCount.WeaponDisplay_GatlingGun_AmmoCount_C.GetPercent_1
	 */
	struct UWeaponDisplay_GatlingGun_AmmoCount_C_GetPercent_1_Params
	{
	public:
		float                                                      ReturnValue;                                             // 0x0000(0x0004)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_LH0O[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function WeaponDisplay_GatlingGun_AmmoCount.WeaponDisplay_GatlingGun_AmmoCount_C.AdjustPercentage
	 */
	struct UWeaponDisplay_GatlingGun_AmmoCount_C_AdjustPercentage_Params
	{	};

	/**
	 * Function WeaponDisplay_GatlingGun_AmmoCount.WeaponDisplay_GatlingGun_AmmoCount_C.AnimateClipCount
	 */
	struct UWeaponDisplay_GatlingGun_AmmoCount_C_AnimateClipCount_Params
	{	};

	/**
	 * Function WeaponDisplay_GatlingGun_AmmoCount.WeaponDisplay_GatlingGun_AmmoCount_C.AdjustProgressBar
	 */
	struct UWeaponDisplay_GatlingGun_AmmoCount_C_AdjustProgressBar_Params
	{	};

	/**
	 * Function WeaponDisplay_GatlingGun_AmmoCount.WeaponDisplay_GatlingGun_AmmoCount_C.Check AmmoLow
	 */
	struct UWeaponDisplay_GatlingGun_AmmoCount_C_CheckAmmoLow_Params
	{	};

	/**
	 * Function WeaponDisplay_GatlingGun_AmmoCount.WeaponDisplay_GatlingGun_AmmoCount_C.SetTotalCount
	 */
	struct UWeaponDisplay_GatlingGun_AmmoCount_C_SetTotalCount_Params
	{
	public:
	 ...
	 */
	struct UWeaponDisplay_GatlingGun_AmmoCount_C_SetMaxAmmo_Params
	{
	public:
		int32_t                                                    Value;                                                   // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	 ...
	 */
	struct UWeaponDisplay_GatlingGun_AmmoCount_C_Construct_Params
	{	};

	/**
	 * Function WeaponDisplay_GatlingGun_AmmoCount.WeaponDisplay_GatlingGun_AmmoCount_C.OnAmmoLowFinished
	 */
	struct UWeaponDisplay_GatlingGun_AmmoCount_C_OnAmmoLowFinished_Params
	{	};
	 ...
	 */
	struct UWeaponDisplay_GatlingGun_AmmoCount_C_ExecuteUbergraph_WeaponDisplay_GatlingGun_AmmoCount_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_4FQC[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
