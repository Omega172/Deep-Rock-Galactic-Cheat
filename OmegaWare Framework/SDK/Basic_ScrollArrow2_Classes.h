...
namespace CG
{
	...
	public:
		...
		class UHorizontalBox*                                      HorizontalBox_103;                                       // 0x0278(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
