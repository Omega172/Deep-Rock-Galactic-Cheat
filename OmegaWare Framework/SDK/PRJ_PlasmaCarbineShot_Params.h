...
namespace CG
{
	 ...
	 */
	struct APRJ_PlasmaCarbineShot_C_GetDamageComponent_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_UDPR[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_80O8[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
