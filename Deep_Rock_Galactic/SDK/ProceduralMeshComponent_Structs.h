...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_6CSM[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		struct FCoreUObject_FBox                                   SectionLocalBox;                                         // 0x0020(0x001C) ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_9J0I[0x2];                                   // 0x003E(0x0002) MISSED OFFSET (PADDING)
	};
