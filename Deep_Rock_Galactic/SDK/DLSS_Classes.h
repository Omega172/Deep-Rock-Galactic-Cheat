...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_M9FX[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_NBKO[0x1];                                   // 0x002F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_K9PI[0x3];                                   // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_R2VD[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (PADDING)
