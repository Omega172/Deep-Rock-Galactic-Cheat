...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_PBHO[0x2];                                   // 0x028E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_UI_CircularProgressBar(int32_t EntryPoint);
