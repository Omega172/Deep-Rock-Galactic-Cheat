...
namespace CG
{
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		struct FCoreUObject_FBox                           InBoundingBox                                              (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	 */
	void UARCandidateObject::SetBoundingBox(const struct FCoreUObject_FBox& InBoundingBox)
	{
		static UFunction* fn = nullptr;
		if (!fn)
