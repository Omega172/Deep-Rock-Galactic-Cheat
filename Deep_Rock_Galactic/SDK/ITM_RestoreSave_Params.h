...
namespace CG
{
	 ...
	 */
	struct UITM_RestoreSave_C_CheckSavegame_Params
	{	};

	/**
	 * Function ITM_RestoreSave.ITM_RestoreSave_C.PreConstruct
	 */
	struct UITM_RestoreSave_C_PreConstruct_Params
	{
	public:
	 ...
	 */
	struct UITM_RestoreSave_C_OnShowRestoreSaveClicked__DelegateSignature_Params
	{	};
