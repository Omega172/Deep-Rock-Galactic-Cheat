...
namespace CG
{
	 ...
	 */
	struct ABP_JetBootsBoxLid_C_ReceiveBeginPlay_Params
	{	};
	 ...
	 */
	struct ABP_JetBootsBoxLid_C_BndEvt__BP_JetBootsBoxLid_StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct ABP_JetBootsBoxLid_C_ExecuteUbergraph_BP_JetBootsBoxLid_Params
	{
	public:
