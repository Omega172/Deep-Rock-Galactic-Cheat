...
namespace CG
{
	...
	public:
		...
		class UJobs_List_Element_BG_CutCorner_C*                   Jobs_List_Element_BG_CutCorner_2;                        // 0x0298(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class UImage*                                              outline_2;                                               // 0x02A8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		void SetData(class UCampaign* Campaign, const class FText& Headline, bool ShowTimer, bool AllRequirementsMet);
		void UpdateTime();
