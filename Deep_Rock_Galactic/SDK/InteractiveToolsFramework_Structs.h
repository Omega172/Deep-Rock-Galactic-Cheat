...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_TAWN[0xA8];                                  // 0x0000(0x00A8) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_S39L[0x18];                                  // 0x0008(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_7QLS[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_IOPJ[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
