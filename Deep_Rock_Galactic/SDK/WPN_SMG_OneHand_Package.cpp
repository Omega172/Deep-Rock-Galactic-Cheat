...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function WPN_SMG_OneHand.WPN_SMG_OneHand_C.RecieveEquipped
	 * 		Flags  -> ()
	 */
	void AWPN_SMG_OneHand_C::RecieveEquipped()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WPN_SMG_OneHand.WPN_SMG_OneHand_C.RecieveEquipped");
