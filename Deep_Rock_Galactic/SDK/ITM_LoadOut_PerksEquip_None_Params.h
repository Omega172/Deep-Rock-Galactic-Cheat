...
namespace CG
{
	 ...
	 */
	struct UITM_LoadOut_PerksEquip_None_C_OnMouseButtonUp_Params
	{
	public:
	 ...
	 */
	struct UITM_LoadOut_PerksEquip_None_C_PreConstruct_Params
	{
	public:
	 ...
	 */
	struct UITM_LoadOut_PerksEquip_None_C_Construct_Params
	{	};

	/**
	 * Function ITM_LoadOut_PerksEquip_None.ITM_LoadOut_PerksEquip_None_C.OnMouseEnter
	 */
	struct UITM_LoadOut_PerksEquip_None_C_OnMouseEnter_Params
	{
	public:
		struct FGeometry                                           MyGeometry;                                              // 0x0000(0x0038)  (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
		struct FPointerEvent                                       MouseEvent;                                              // 0x0038(0x0070)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	 ...
	 */
	struct UITM_LoadOut_PerksEquip_None_C_OnMouseLeave_Params
	{
	public:
	 ...
	 */
	struct UITM_LoadOut_PerksEquip_None_C_Refresh_Params
	{	};

	/**
	 * Function ITM_LoadOut_PerksEquip_None.ITM_LoadOut_PerksEquip_None_C.ExecuteUbergraph_ITM_LoadOut_PerksEquip_None
	 */
	struct UITM_LoadOut_PerksEquip_None_C_ExecuteUbergraph_ITM_LoadOut_PerksEquip_None_Params
	{
	public:
	 ...
	 */
	struct UITM_LoadOut_PerksEquip_None_C_OnClicked__DelegateSignature_Params
	{	};
