...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3BPN[0x10];                                  // 0x0358(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1AYF[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7QFS[0x8];                                   // 0x00B0(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_BXS8[0x8];                                   // 0x00B0(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5G3R[0x3];                                   // 0x0235(0x0003) MISSED OFFSET (PADDING)
