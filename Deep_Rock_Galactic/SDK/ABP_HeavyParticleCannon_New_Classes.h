...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_XFZM[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_TCWE[0x3];                                   // 0x0591(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
