...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NVIX[0x8];                                   // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRigVMMemoryContainer                               LiteralMemoryStorage;                                    // 0x00D0(0x00A0) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_M2YN[0x8];                                   // 0x0170(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRigVMByteCode                                      ByteCodeStorage;                                         // 0x0178(0x0030) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_IMR6[0x8];                                   // 0x01A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7C4W[0x20];                                  // 0x0228(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0XWM[0x48];                                  // 0x02A8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
