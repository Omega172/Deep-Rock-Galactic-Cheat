...
namespace CG
{
	...
	public:
		...
		class UTerrainPlacementComponent*                          terrainPlacement;                                        // 0x02F0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
