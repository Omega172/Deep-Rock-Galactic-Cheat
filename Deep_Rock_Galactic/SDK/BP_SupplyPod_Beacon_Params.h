...
namespace CG
{
	...
	/**
	 * Function BP_SupplyPod_Beacon.BP_SupplyPod_Beacon_C.Timeline_0__FinishedFunc
	 */
	struct ABP_SupplyPod_Beacon_C_Timeline_0__FinishedFunc_Params
	{	};

	/**
	 * Function BP_SupplyPod_Beacon.BP_SupplyPod_Beacon_C.Timeline_0__UpdateFunc
	 */
	struct ABP_SupplyPod_Beacon_C_Timeline_0__UpdateFunc_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_N3EP[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
