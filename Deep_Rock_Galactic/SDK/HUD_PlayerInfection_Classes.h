...
namespace CG
{
	...
	public:
		...
		void OnInfectionChanged(int32_t IntValue);
		void OnInfectionStateChangedEvent_Event_1(EInfectionState State);
		void ExecuteUbergraph_HUD_PlayerInfection(int32_t EntryPoint);
