...
namespace CG
{
	 ...
	 */
	struct ABP_CompleteMissionScreen_DorettaHead_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BP_CompleteMissionScreen_DorettaHead.BP_CompleteMissionScreen_DorettaHead_C.StartPlay
	 */
	struct ABP_CompleteMissionScreen_DorettaHead_C_StartPlay_Params
	{
	public:
	 ...
	 */
	struct ABP_CompleteMissionScreen_DorettaHead_C_ExecuteUbergraph_BP_CompleteMissionScreen_DorettaHead_Params
	{
	public:
