...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RD78[0x7];                                   // 0x02F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              cFirstTimeShout[0x28];                                    // 0x0308(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
