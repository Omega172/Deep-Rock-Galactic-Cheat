...
namespace CG
{
	 ...
	 * Size -> 0x0068 (FullSize[0x0558] - InheritedSize[0x04F0])
	 */
	...
	public:
		...
		class UDialogDataAsset*                                    Grenadewarning;                                          // 0x0540(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_Grenade_BouncyBoomerang(int32_t EntryPoint);
